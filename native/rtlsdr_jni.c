...
JNIEXPORT jint JNICALL Java_sdr_RtlSdr_open
  (JNIEnv *env, jobject obj, jint index)
{
    return rtlsdr_open(&dev, index);
}

JNIEXPORT jint JNICALL Java_sdr_RtlSdr_setCenterFreq
  (JNIEnv *env, jobject obj, jint freq)
{
    return rtlsdr_set_center_freq(dev, freq);
}

JNIEXPORT jint JNICALL Java_sdr_RtlSdr_setSampleRate
  (JNIEnv *env, jobject obj, jint rate)
{
    return rtlsdr_set_sample_rate(dev, rate);
}

JNIEXPORT jint JNICALL Java_sdr_RtlSdr_setGain
...
JNIEXPORT jint JNICALL Java_sdr_RtlSdr_resetBuffer
  (JNIEnv *env, jobject obj)
{
    return rtlsdr_reset_buffer(dev);
}

JNIEXPORT jint JNICALL Java_sdr_RtlSdr_read
...
JNIEXPORT void JNICALL Java_sdr_RtlSdr_close
  (JNIEnv *env, jobject obj)
{
    if (dev) {
        rtlsdr_close(dev);
